...
Website spectra: 0.1--10 kHz default, common 0--0.9-s interval, 1/12-octave mean linear FFT power, per-signal mean FFT-bin power normalization over 0.1--10 kHz. Original 15-kHz paper figures and a separately labeled existing 20-kHz diagnostic are additional assets. Spectrograms: Hann 1024, hop 128, FFT 1024, boundary zeros, no padded final STFT frame; 0--0.9 s and 0.1--10 kHz; normalization by each panel mean power; shared -20 to +30 dB. Waveforms: 0--250 ms and independent display-only peak normalization. The supplementary P1/P2/P3 strip uses linear amplitude. The updated combined paper figure uses all eight modes in a 2 x 2 time-domain grid with meeting-room / hallway rows and recorded-clap / inferred-RIR columns, matching the spectral layout. Magnitude (dB) is 20 log10 of the absolute peak-normalized waveform, floored at -80 dB for display, without smoothing.
